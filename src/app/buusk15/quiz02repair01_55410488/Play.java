...
//	}
	...
	public void onClick(View v) {
		...
		case R.id.btnp1_488:		
			...
			db.InsertPlayStatus(strPlay1, strPlayer1, total1, con1, Score1);
			db.InsertPlayStatus(strPlay2, strPlayer2, total2, con0, Score2);
			db.InsertPlayStatus(strPlay3, strPlayer3, total3, con0, Score3);
			break;
		...
		case R.id.btnp2_488:
			...
			db.InsertPlayStatus(strPlay1, strPlayer1, total1, con0, Score1);
			db.InsertPlayStatus(strPlay2, strPlayer2, total2, con1, Score2);
			db.InsertPlayStatus(strPlay3, strPlayer3, total3, con0, Score3);
			break;
		...
		case R.id.btnp3_488:	
			...
			db.InsertPlayStatus(strPlay1, strPlayer1, total1, con0, Score1);
			db.InsertPlayStatus(strPlay2, strPlayer2, total2, con0, Score2);
			db.InsertPlayStatus(strPlay3, strPlayer3, total3, con1, Score3);		
			break;
